...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb1', 'x_pose': '-2', 'y_pose': '1', 'z_pose': 0.01},
        {'name': 'tb2', 'x_pose': '6', 'y_pose': '1', 'z_pose': 0.01},
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        #parameters=[{'yaml_filename': os.path.join(get_package_share_directory('turtlebot3_multi_robot'), 'maps', 'turtlebot3_house_map.yaml')}],
        # modified for the new map
